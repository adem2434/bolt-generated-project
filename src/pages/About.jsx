        ...
        <div className="max-w-7xl mx-auto px-4 py-10 md:py-16 fade-in">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 items-center">
            <div>
              ...
              <p className="text-gray-400 mb-4 md:mb-5 text-base md:text-lg leading-relaxed">
                Vulgar was founded with a vision to create clothing that transcends trends and speaks to the individual. We own our workshops, ensuring that every piece we produce is a reflection of our commitment to quality and authenticity. From streetwear that captures the essence of urban life to formal fashion that exudes elegance, our collections are designed to empower and inspire.
              </p>
            ...
            <div className="h-[200px] md:h-[300px] bg-zinc-900">
              <img
                src="https://iili.io/2iDERmG.md.jpg"
                alt="About Us"
